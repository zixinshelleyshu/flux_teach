...
XXX Show the same with data from 5 sites and time-invariant data
included in model training. Can show it in a condensed form,
highlighting the differences to above.
